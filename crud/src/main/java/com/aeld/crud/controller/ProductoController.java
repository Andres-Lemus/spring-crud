package com.aeld.crud.controller;
...
import com.aeld.crud.dto.ProductoDto;
import com.aeld.crud.entity.Producto;
import com.aeld.crud.service.ProductoService;
...
public class ProductoController {
    ...
    public ResponseEntity<Mensaje> create(@RequestBody ProductoDto productoDto){
        ...
        if (productoDto.getPrecio() == null || productoDto.getPrecio() < 0) {
            return new ResponseEntity<Mensaje>(new Mensaje("El precio debe de ser mayor que 0.0"), HttpStatus.BAD_REQUEST);
        }
